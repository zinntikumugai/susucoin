...
* susucoin.conf: contains configuration settings for susucoind or susucoin-qt
* susucoind.pid: stores the process id of susucoind while running
...
* debug.log: contains debug information and general logging generated by susucoind or susucoin-qt
