Susucoin Core version 0.9.4 is now available from:

  https://susucoin.org/bin/0.9.4/
...
this update is incompatible with the Susucoin system and could lead to consensus
forks.

Susucoin Core released binaries from https://susucoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~susucoin/+archive/ubuntu/susucoin
- A third-party or self-compiled Susucoin Core

upgrade to Susucoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
