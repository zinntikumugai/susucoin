Susucoin Core version 0.10.4 is now available from:

  <https://susucoin.org/bin/susucoin-core-0.10.4/>
...
- #6953 `43c2789` Split susucoin-tx into its own package
- #6953 `dfe0d4d` Include susucoin-tx binary on Debian/Ubuntu
