Susucoin Core version 0.13.2 is now available from:

  <https://susucoin.org/bin/susucoin-core-0.13.2/>
...
- #8908 `4a974b2` Update susucoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow susucoin-tx to create v2 transactions (btcdrak)
