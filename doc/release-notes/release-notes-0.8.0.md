Susucoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/susucoin/files/Susucoin/susucoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Susucoin
...
New/changed settings (command-line or susucoin.conf file)
--------------------------------------------------------
