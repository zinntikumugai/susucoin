Susucoin Core version 0.16.1 is now available from:

  <https://susucoincore.org/bin/susucoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting susucoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure susucoind processes are cleaned up when tests end (sdaftuar)
