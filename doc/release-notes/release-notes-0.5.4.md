Susucoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/susucoin/files/Susucoin/susucoin-0.5.4/
...
http://gitorious.org/susucoin/susucoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Susucoin-Qt notifications under Growl 1.3.
Increase required age of Susucoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSusucoin properly when installing Susucoin-Qt over it. (Windows)
