...
BOOST_AUTO_TEST_CASE(netbase_properties)
{
    ...
    BOOST_CHECK(CreateInternal("FD35:9E50:C8C3:edb1:8e4:3588:e546:35ca").IsInternal());
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("[fd35:9e50:c8c3:1:2:3:4:5]", "[::]:0"));
    // and that a one-off resolves correctly
    BOOST_CHECK(TestParse("[fd35:9e50:c8c3:1:2:3:4:5]", "[fd35:9e50:c8c3:1:2:3:4:5]:65535"));
}
